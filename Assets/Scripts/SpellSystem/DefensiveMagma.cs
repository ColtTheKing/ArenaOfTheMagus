...
public class DefensiveMagma : Spell
{
    public float dps, slowAmount, debuffDuration, distanceAhead;
    ...
    void OnCollisionStay(Collision collision)
    {
        ...
        if (enemy != null)
        {
            enemy.Slow(slowAmount, debuffDuration);
            enemy.Ignite(dps, debuffDuration);
        }
    }
}